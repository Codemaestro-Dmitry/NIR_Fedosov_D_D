...
private slots:
    ...
    //void onGraphSaved(const QString &folderPath);
    bool exportSceneAsImage();

    void on_actionDrawGraph_triggered(); // Окно для создания графа

private:
    Ui::MainWindow *ui;
    QGraphicsScene *scene = nullptr;
    DrawGrafWindow *drawGrafWindow = nullptr;
    DrawGrafWindow *m_drawWindow;
